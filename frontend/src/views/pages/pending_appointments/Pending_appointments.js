          ...
          <CTable>
            <CTableHead>
              <CTableRow>
                ...
                <CTableHeaderCell scope="col">Doctor First Name</CTableHeaderCell>
                <CTableHeaderCell scope="col">Doctor Last Name</CTableHeaderCell>
            ...
            <CTableBody>
              ...
              {data.map((r, i) => (
                <CTableRow key={i}>
                  ...
                  <CTableDataCell>{r.doctor_first_name}</CTableDataCell>
                  <CTableDataCell>{r.doctor_last_name}</CTableDataCell>
                  ...
                  <CButtonGroup size="sm" role="group" aria-label="Small button group">
                    <div class="btn-group btn-group-sm" role="group" aria-label="Small button group">
                      <button type="button" class="btn btn-outline-dark"> <Link to={`/doctor_data/update_doctor/${r.id}`} variant="outline" onClick={e => handleApprove(r.id)}>Approve</Link></button>
                      <button type="button" class="btn btn-outline-dark"><Link to={`/doctor_data/update_doctor`} variant="outline" onClick={e => handleDecline(r.id)}>Decline</Link></button>
                    </div>
                  </CButtonGroup>
                </CTableRow>
              ))}
